...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_node_modules_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(routes)],
            exports: [_node_modules_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
        })
    ], AppRoutingModule);
...
/* harmony import */ var _questions_questions_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./questions/questions.component */ "./src/app/questions/questions.component.ts");
...
/* harmony import */ var _sidemenu_sidemenu_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./sidemenu/sidemenu.component */ "./src/app/sidemenu/sidemenu.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _questions_questions_component__WEBPACK_IMPORTED_MODULE_19__["QuestionsComponent"],
                _home_home_component__WEBPACK_IMPORTED_MODULE_20__["HomeComponent"],
                _sidemenu_sidemenu_component__WEBPACK_IMPORTED_MODULE_21__["SidemenuComponent"]
            ],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
                _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"],
                _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["NoopAnimationsModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"],
                _angular_material_expansion__WEBPACK_IMPORTED_MODULE_5__["MatExpansionModule"],
                _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"],
                _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_7__["MatDatepickerModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatNativeDateModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatCheckboxModule"],
            ...
            entryComponents: [_home_home_component__WEBPACK_IMPORTED_MODULE_20__["HomeComponent"]],
            providers: [],
...
/***/ "./src/app/factorymodel.service.ts":
/*!*****************************************!*\
  !*** ./src/app/factorymodel.service.ts ***!
  \*****************************************/
/*! exports provided: FactorymodelService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FactorymodelService", function() { return FactorymodelService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FactorymodelService = /** @class */ (function () {
    //factories : Factory;
    function FactorymodelService(http) {
        this.http = http;
        this.factoriesSubject = new _node_modules_rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.factoriesUpdated = this.factoriesSubject.asObservable();
        this.yearsSubject = new _node_modules_rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.yearsUpdated = this.yearsSubject.asObservable();
        this.getFactories();
    }
    FactorymodelService.prototype.getFactories = function () {
        var _this = this;
        this.http.get('factoriesApi/').subscribe(function (data) {
            //this.factories = data;
            _this.factoriesSubject.next(data);
        });
    };
    FactorymodelService.prototype.getYears = function (factoryId) {
        var _this = this;
        this.http.get('year_modelsApi/' + factoryId).subscribe(function (data) {
            console.log(data);
            _this.yearsSubject.next(data);
        });
    };
    FactorymodelService = __decorate([
...
module.exports = "\n\n<div class='header'>\n\n    <a href=\"/questions\">\n        <img border=\"0\" alt=\"Car Insurance - Gimel\" src=\"assets\\add_text.jpg\" >\n        \n    </a>\n\n    <h1 class=\"title\"> נטו ביטוח</h1>\n\n    <a href=\"/questions\">\n        <img border=\"0\" alt=\"Car Insurance - Mushlam\" src=\"assets\\tzadgimel.png\" >\n        \n    </a>\n\n\n\n\n</div>\n"
...
/* harmony import */ var _factorymodel_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../factorymodel.service */ "./src/app/factorymodel.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuestionsComponent = /** @class */ (function () {
    ...
    function QuestionsComponent(_formBuilder, factorymodel) {
        var _this = this;
        ...
        this.maxDateBorn = new Date();
        this.yearLicenses = [];
        this.factorymodel.factoriesUpdated.subscribe(function (data) {
            _this.factories = data;
            console.log(data);
        });
        this.factorymodel.yearsUpdated.subscribe(function (data) {
            _this.years_model = data;
            _this.years = _this.filterUnique(data, 'year');
        });
        this.maxDateBorn.setFullYear(this.maxDateBorn.getFullYear() - 18);
    }
    QuestionsComponent.prototype.filterUnique = function (data, key) {
        var resArr = [];
    ...
    QuestionsComponent.prototype.getYears = function (factory) {
        this.factorymodel.getYears(factory.value);
    };
    QuestionsComponent.prototype.getModels = function (year) {
        //console.log(this.firstFormGroup.get('startdate').value);
        this.yearFactory = year.value;
        this.models = this.years_model.filter(function (models) { return models.year == year.value; });
        var resArr = [];
        this.models.filter(function (item) {
            var i = resArr.findIndex(function (x) { return x['modelName'] == item['modelcar']['modelName']; });
            if (i <= -1) {
    ...
    QuestionsComponent.prototype.getModelsDistinct = function (model) {
        var _this = this;
        this.modelcars = this.models.filter(function (models) {
            return ((models['modelcar']['modelName'] == model.value) &&
                (models['year'] == _this.yearFactory));
        });
    };
    QuestionsComponent.prototype.getAlarm = function ($event) {
        this.alarm = true;
    };
    QuestionsComponent.prototype.getYearsLicense = function ($event) {
        this.yearLicenses = ['פחות משנה', 'שנה'];
        var yearMinLicense = $event.value.getFullYear() + 18;
        var countYear = 2;
    ...
    QuestionsComponent.prototype.form1 = function () {
    ...
    QuestionsComponent.prototype.ngOnInit = function () {
        this.firstFormGroup = this._formBuilder.group({
            datestart: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]
        });
        this.secondFormGroup = this._formBuilder.group({
            ...
            modelcar: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            alarm: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            alarmeye: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]
        });
        this.thirdFormGroup = this._formBuilder.group({
            numberDriver: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            genderDriver: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            dateDriverBorn: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            yearsLicense: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]
        });
        this.fourthFormGroup = this._formBuilder.group({
            avarBituach: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            avarBefore1: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            avarBefore2: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            avarBefore3: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            tviot: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            avarTviot: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            tviotGuf: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            avarTviotGuf: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]
        });
    };
    QuestionsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _factorymodel_service__WEBPACK_IMPORTED_MODULE_2__["FactorymodelService"]])
    ], QuestionsComponent);
...
module.exports = "\n\n\n<mat-toolbar color=\"primary\" class=\"example-toolbar\">\n  <button mat-icon-button (click)=\"snav.toggle()\"><mat-icon>menu</mat-icon></button>\n  <h1 class=\"example-app-name\">נטו ביטוח</h1>\n</mat-toolbar>\n\n\n<mat-sidenav-container class=\"example-sidenav-container\"\n[style.marginTop.px]=\"mobileQuery.matches ? 0 : 0\">\n<mat-sidenav #snav [mode]=\"mobileQuery.matches ? 'side' : 'side'\"\n[fixedInViewport]=\"false\">\n<mat-nav-list (click)=\"snav.close()\"> \n\n<a mat-list-item routerLink=\".\" >Home</a>\n<a mat-list-item routerLink=\"/about\" >מי אנחנו</a>\n<a mat-list-item routerLink=\"/car-insurance\">ביטוח רכב</a>\n\n<a mat-list-item routerLink=\"/contact\">יצירת קשר</a>\n\n</mat-nav-list>\n</mat-sidenav>\n\n\n  <mat-sidenav-content>\n    <router-outlet></router-outlet>\n    \n  </mat-sidenav-content>\n</mat-sidenav-container>\n\n\n"
...
var SidemenuComponent = /** @class */ (function () {
    function SidemenuComponent(changeDetectorRef, media) {
...
module.exports = __webpack_require__(/*! C:\Users\lptop\Desktop\insurance\src\main.ts */"./src/main.ts");
